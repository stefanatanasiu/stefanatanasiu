...
#walk_dir = sys.argv[1]
walk_dir = "C:"
conn = sqlite3.connect('C:\DataSets\listing.db')
c = conn.cursor()
# Create table
try:
    c.execute('''CREATE TABLE listing (file text, size number, hash text, last_modified real)''')
except Error as e:
    print(e)
...
for root, subdirs, files in os.walk(walk_dir):
    ...
    for file in files:
        ...
        try: 
            ...
            chestia = file_path, f_size, f_asum, last_modified
